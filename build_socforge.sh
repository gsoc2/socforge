#!/usr/bin/env bash
# Build socforge installers for Linux
...
DOCKERIMAGE=${DOCKERIMAGE:-soc2/linux-anvil-aarch64}
export SOCFORGE_NAME=${SOCFORGE_NAME:-Socforge3}
...
docker run --rm -v "$(pwd):/construct" \
  -e CONSTRUCT_ROOT -e SOCFORGE_VERSION -e SOCFORGE_NAME -e TARGET_PLATFORM \
